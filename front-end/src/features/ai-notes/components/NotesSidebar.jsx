...
export default function NotesSidebar({
  ...
  const sidebarContent = (
    <div className="w-72 h-full flex flex-col shrink-0">
      <div className="flex items-center justify-between px-5 py-4 border-b border-histo-dark/10 min-h-[64px] shrink-0">
      ...
      {/* New Chat Button */}
      <div className="p-3 border-b border-histo-dark/10 shrink-0">
        <button
          type="button"
          onClick={onNewChat}
      ...
      {/* Sidebar Footer */}
      <div className="p-3 border-t border-histo-dark/10 bg-histo-cream/30 shrink-0">
